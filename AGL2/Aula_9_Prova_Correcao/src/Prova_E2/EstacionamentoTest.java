...
public class EstacionamentoTest {
    private static Estacionamento meu_estacionamento = new Estacionamento("Meu Estacionamento", 5.30);
    ...
    private static void procurar_carro_placa(String string) {
        ...
        System.out.println("Carro com placa " + string + " existe: " + meu_estacionamento.procurar_carro_placa(string));
    }
